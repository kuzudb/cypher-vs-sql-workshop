...
| Query | Description
| --- | ---
| 1 | Find all possible direct transfers between two accounts owned by persons with emails `georodaw366@hotmail.com` and `ezimmerman@yahoo.com`. <br>**Hint:** Since you need to look for transfers both from `georodaw366@hotmail.com` to `ezimmerman@yahoo.com` and vice versa, you may want to use the [undirected relationship patterns](https://docs.kuzudb.com/cypher/query-clauses/match/#match-undirected-relationships) in MATCH clauses.
